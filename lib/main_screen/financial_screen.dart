...
import 'home_screen/after_retirement_plan/after_retirement_screen.dart';
import 'home_screen/money_management/money_management.dart';
import 'home_screen/saving_goals/saving_goals_screen.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            ...
                            Container(
                              width: MediaQuery.of(context).size.width /
                                  ...
                                  130.5,
                              child: Text(
                                "Tổng hợp những chi tiêu của bạn theo một danh sách các ngày để bạn có thể dễ dàng theo dõi những khoản mục chi tiêu của mình.",
                                style: TextStyle(
                                  fontFamily: 'Inter',
                                  color: Color(0xff999999),
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AfterRetirementScreen(
                                  docSnap.data()['listRetirement'] == null
                                      ? []
                                      : docSnap.data()['listRetirement'])));
                    },
                    child: Container(
                      width: MediaQuery.of(context).size.width / 187.5 * 171.5,
                  ...
                  InkWell(
                    onTap: () {
                      var data = docSnap.data()['listSavingGoals'] == null
                          ? []
                          : docSnap.data()['listSavingGoals'];
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SavingGoalsScreen(data)));
                    },
                    child: Container(
                      width: MediaQuery.of(context).size.width / 187.5 * 171.5,
                          ...
                          children: [
                            ...
                            Container(
                              width: MediaQuery.of(context).size.width /
                                  ...
                                  130.5,
                              child: Text(
                                "Hỗ trợ bạn tạo mục tiêu tiết kiệm và theo dõi tiến độ tiết kiệm để giúp bạn đạt được mục tiêu mua sắm, đầu tư trong tương lai.",
                                style: TextStyle(
                                  fontFamily: 'Inter',
                                  color: Color(0xff999999),
                                  fontSize: 12 * curScaleFactor,
                          ...
                          children: [
                            ...
                            Container(
                              width: MediaQuery.of(context).size.width /
                                  ...
                                  130.5,
                              child: Text(
                                "Gợi ý những gói đầu tư phù hợp với tình hình tài chính của bạn hiện tại, giúp bạn có được danh mục đầu tư ổn định và bền vững.",
                                style: TextStyle(
                                  fontFamily: 'Inter',
                                  color: Color(0xff999999),
                                  fontSize: 12 * curScaleFactor,
