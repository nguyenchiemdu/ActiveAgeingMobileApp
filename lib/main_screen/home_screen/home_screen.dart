    ...
    return Consumer<DocumentSnapshot?>(builder: (context, docSnap, child) {
      ...
      children: [
        ...
        Container(
            ...
            child: Row(
              children: [
                Image.asset("assets/images/fincare-icon.png",width:40,height:40),
                new Text("FinCare",
                    style: TextStyle(
                      fontFamily: 'Inter',
              ...
              children: [
                Container(
                    ...
                    child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                        Image.asset("assets/images/smaller_retirement_icon.png",width:25,height:25),
                        Container(
                          width: MediaQuery.of(context).size.width / 187.5 * 4,
                ...
                Container(
                    ...
                    child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset("assets/images/smaller_saving_icon.png",width:25,height:25),
                          Container(
                            width: MediaQuery.of(context).size.width / 187.5 * 4,
                            height: MediaQuery.of(context).size.height / 333.5 * 4,
                          ),
                ...
                Container(
                    ...
                    child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset("assets/images/smaller_invest_icon.png",width:25,height:25),
                          Container(
                            width: MediaQuery.of(context).size.width / 187.5 * 4,
                            height: MediaQuery.of(context).size.height / 333.5 * 4,
                          ),
        ...
        Container(
            ...
            child: Row(
                children: [
                  Image.asset("assets/images/healthcare-icon.png",width:40,height:40),
            ...
            children: [
              Container(
                ...
                child: Row(
                    children: [
                    Container(
                        width: MediaQuery.of(context).size.width / 187.5 * 83.5,
                        height: MediaQuery.of(context).size.height / 333.5 * 44,
                        decoration: BoxDecoration(
                            color:Color(0xffffffff),
                            borderRadius: BorderRadius.circular(12)
                        ...
                        child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Image.asset("assets/images/check_up_icon.png",width:25,height:25),
                              Container(
                                width: MediaQuery.of(context).size.width / 187.5 * 4,
                                height: MediaQuery.of(context).size.height / 333.5 * 4,
                              ),
                    ...
                    Container(
                        ...
                        child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Image.asset("assets/images/community_icon.png",width:25,height:25),
                              Container(
                                width: MediaQuery.of(context).size.width / 187.5 * 4,
                                height: MediaQuery.of(context).size.height / 333.5 * 4,
                              ),
                    ...
                    children: [
                      Container(
                          ...
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image.asset("assets/images/products_icon.png",width:25,height:25),
                                Container(
                                  width: MediaQuery.of(context).size.width / 187.5 * 4,
                                  height: MediaQuery.of(context).size.height / 333.5 * 4,
                                ),
                      ...
                      Container(
                          ...
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image.asset("assets/images/workshops_icon.png",width:25,height:25),
                                Container(
                                  width: MediaQuery.of(context).size.width / 187.5 * 4,
                                  height: MediaQuery.of(context).size.height / 333.5 * 4,
                                ),
        ...
        Container(
          ...
          child: Row(
              children: [
                Image.asset("assets/images/social-activity-icon.png",width:40,height:40),
