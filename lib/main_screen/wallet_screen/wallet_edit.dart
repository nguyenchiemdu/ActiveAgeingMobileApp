                ...
                children: [
                  Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          wallet['type'] == 'cash'
                              ? Image.asset("assets/images/cash_icon.png", width: 30, height: 30)
                              : Image.asset("assets/images/pig_icon.png", width: 30, height: 30),
                          Container(
                            width: MediaQuery.of(context).size.width / 187.5 * 8,
                            height: MediaQuery.of(context).size.height / 333.5 * 1,
                          ),
                  ...
                  Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Image.asset("assets/images/amount_icon.png", width: 30, height: 30),
                          Container(
                            width: MediaQuery.of(context).size.width / 187.5 * 8,
                            height: MediaQuery.of(context).size.height / 333.5 * 1,
                          ),
                  ...
                  Container(
                      ...
                      children: [
                        ...
                        Image.asset("assets/images/currency_icon.png", width: 30, height: 30),
                        Container(
                          width: MediaQuery.of(context).size.width / 187.5 * 8,
                          height: MediaQuery.of(context).size.height / 333.5 * 1,
                        ),
