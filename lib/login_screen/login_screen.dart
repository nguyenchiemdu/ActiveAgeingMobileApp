                ...
                children: [
                  ...
                  Center(
                    child: Container(
                        ...
                        height: MediaQuery.of(context).size.height / 333.5 * 62,
                      child: Image.asset("assets/images/logo_aav.png")
                    ),
                  ),
                  Container(
                    width: MediaQuery.of(context).size.width / 187.5 * 1,
                  ...
                  Center(
                    child: Container(
                      ...
                      decoration: new BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(12),
                          border:
                              Border.all(width: 1.0, color: Color(0xff98E8CB))),
                      child: Align(
                        alignment: Alignment.centerLeft,
                        child: TextFormField(
                          validator: (value) {
                  ...
                  Center(
                    child: Container(
                      ...
                      child: ElevatedButton(
                          style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all<Color>(Color(0xff98E8CB)),
                          ),
                          onPressed: () async {
